        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<int>(type: "INTEGER", nullable: false),
                    QualificationIdValue = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffMemberQualifications", x => new { x.StaffMemberMecanographicNumber, x.Id });
                    table.ForeignKey(
                        name: "FK_StaffMemberQualifications_StaffMembers_StaffMemberMecanographicNumber",
